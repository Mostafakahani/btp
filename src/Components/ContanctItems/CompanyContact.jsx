                            ...
                            <Grid item xs={12} sm={6} sx={{ display: 'flex', flexDirection: 'column', alignContent: 'center', flexWrap: 'nowrap', justifyContent: 'space-between' }}>
                                ...
                                <Grid container sx={{ display: 'flex', justifyContent: 'space-between', flexDirection: "row", flexWrap: 'nowrap', my: { xs: '15px', sm: '0' } }}>
                                    ...
                                    <Grid container sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                                        ...
                                        <SvgIcon sx={{ ml: '10px' }}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                <path d="M16.7533 19.9932H7.43731C4.6425 19.9932 2.7793 18.5388 2.7793 15.1453V8.3581C2.7793 4.96452 4.6425 3.51013 7.43731 3.51013H16.7533C19.5482 3.51013 21.4114 4.96452 21.4114 8.3581V15.1453C21.4114 18.5388 19.5482 19.9932 16.7533 19.9932Z" stroke="url(#paint0_linear_144_122)" strokeWidth="1.3974" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M16.753 8.84277L13.8371 11.2668C12.8776 12.0618 11.3032 12.0618 10.3436 11.2668L7.43701 8.84277" stroke="url(#paint1_linear_144_122)" strokeWidth="1.3974" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                                <defs>
