            ...
            <Grid container justifyContent="center" alignItems="center">
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <Grid container sx={{ my: '5px', position: 'relative' }}>
                            <Grid item xs={12} sm={6} sx={{ display: 'flex', flexDirection: 'column', alignContent: 'center', flexWrap: 'nowrap', justifyContent: 'space-between' }}>
                                <Grid container sx={{ display: 'flex', justifyContent: 'space-between', flexDirection: "row", flexWrap: 'nowrap' }}>
                            ...
                            <Grid item xs={12} sm={6} sx={{ my: '10px' }}>
                                <Typography variant="h5" sx={{ color: "#FFF", textAlign: 'right', mb: '10px',fontWeight: 600 }}>شرکت بازرگانی بارمان تجارت پایدار</Typography>
