                ...
                <Grid sx={{ display: 'flex', justifyContent: "center", alignItems: 'flex-start', flexDirection: 'column', }}>
                    ...
                    {/* <Link href={texts.emailLink}>
                        <Grid sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', my: '10px' }}>
                            <SvgIcon sx={{ mr: '20px' }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="26" viewBox="0 0 25 26" fill="none">
                                    <path d="M17.4467 21.4792H7.58119C4.62154 21.4792 2.64844 19.939 2.64844 16.3452V9.15777C2.64844 5.56404 4.62154 4.02386 7.58119 4.02386H17.4467C20.4063 4.02386 22.3794 5.56404 22.3794 9.15777V16.3452C22.3794 19.939 20.4063 21.4792 17.4467 21.4792Z" stroke="url(#paint0_linear_26_364)" strokeWidth="1.47983" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M17.4466 9.67107L14.3586 12.238C13.3425 13.08 11.6752 13.08 10.6591 12.238L7.58105 9.67107" stroke="url(#paint1_linear_26_364)" strokeWidth="1.47983" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                    <defs>
