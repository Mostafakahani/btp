    ...
    data: [
      {
        ...
        text: 'بارمان تجارت پایدار، شرکتی با سابقه‌ای درخشان در تامین مواد اولیه صنایع غذایی، دارویی، کشاورزی، آرایشی، بهداشتی و شیمیایی است. مدیریت این شرکت با تجربه چندین ساله در این زمینه، از سال 1382 فعالیت خود را آغاز کرده و با همت و تلاش بی وقفه، به سرعت به موفقیت رسیده است. شرکت بارمان تجارت پایدار برای اطمینان از کیفیت بالای مواد اولیه، تیم‌هایی را برای بررسی کیفیت هر محصول قبل از خرید، پس از خرید و قبل از ارسال به ایران به نمایندگان کشورهای مختلف اعزام می‌کند. این شرکت با تلاش‌های بی وقفه و با تکیه بر تیم‌های کارشناسی، مواد اولیه با کیفیت بالا را از کشورهای چین، مالزی، کره و هند وارد می‌کند. این شرکت با داشتن بخش‌های مختلفی مانند بخش آزمایشگاه، بخش مدیریتی، بخش بازرگانی و بخش فروش، همیشه در حال فعالیت و پیگیری تلاش برای ارائه بالاترین کیفیت است. بارمان تجارت پایدار با تمرکز بر کیفیت، بهترین مواد اولیه را به تولیدکنندگان ارائه می‌دهد و به همین دلیل، این شرکت به یکی از معتبرترین شرکت‌های تامین کننده تبدیل شده است.',
        ...
        >
          ...
          <SvgIcon onClick={handlePrevSlide} sx={{ cursor: "pointer" }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="37" viewBox="0 0 19 37" fill="none">
              <path d="M17 34.4554L3.63081 21.0962C2.05194 19.5185 2.05194 16.9368 3.63081 15.3592L17 2" stroke="white" strokeWidth="4" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </SvgIcon>
          <SvgIcon onClick={handleNextSlide} sx={{ cursor: "pointer", marginInlineStart: "auto" }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="37" viewBox="0 0 19 37" fill="none">
              <path d="M2.00012 34.4554L15.3693 21.0962C16.9482 19.5185 16.9482 16.9368 15.3693 15.3592L2.00012 2" stroke="white" strokeWidth="4" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </SvgIcon>
        </Grid>
        <Slider
            ...
            return (
              <Grid key={x}>
                <Grid sx={{ position: "relative" }}>
                  ...
                  >
                    <Grid container sx={{ display: "flex", justifyContent: 'center', py: '50px', }}>
                      <Typography
                        variant="h3"
                        sx={{
                      ...
                      <Typography variant="h6" sx={{
                        color: '#FFF', textAlign: 'justify', direction: 'rtl',
                        fontWeight: 200,
                        lineHeight: { md: '1.8' },
