                    ...
                    <Box maxWidth={'lg'} sx={{ flexGrow: 1, p: 5, backgroundColor: '#fff', borderRadius: '30px', mb: '100px' }} >
                        ...
                        >
                            {filteredProducts.map((product, index) => (
                                <Grid item {...colWidth} minHeight={160} sx={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center', transition: ".2s", '&:hover': { backgroundColor: '#f7f7f7', transition: ".5s" } }}>
