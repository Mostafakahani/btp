  ...
  const filteredProducts = products.filter(
    (product) =>
      ...
      (selectedCategory === "All" ||
        product.data[1].category === selectedCategory)
  );
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content={`صفحه محصولات | وب سایت بازرگانی بارمان تجارت پایدار`}
        />
        <meta charSet="UTF-8" />
        <meta name="subject" content={`صفحه مشاهده محصولات `} />
        <meta name="copyright" content="بازرگانی بارمان تجارت پایدار (BTP)" />
        <meta name="robots" content="index,follow" />
        <meta name="language" content="FA" />
        <meta name="url" content={`https://btp.one/Products`} />
      ...
      >
        <Grid
          ...
          container
          spacing={2}
          sx={{ display: "flex", justifyContent: "center", my: "15px" }}
        >
          <Grid
            item
            container
                    ...
                    startAdornment: (
                      <InputAdornment position="start">
                        <SvgIcon sx={{ color: "#012964" }}>
                          ...
                          >
                            <path
                              d="M14.7941 26.4129C21.2638 26.4129 26.5086 21.1681 26.5086 14.6984C26.5086 8.22864 21.2638 2.98389 14.7941 2.98389C8.32435 2.98389 3.07959 8.22864 3.07959 14.6984C3.07959 21.1681 8.32435 26.4129 14.7941 26.4129Z"
                              stroke="#012964"
                              strokeWidth="1.95242"
                              strokeLinecap="round"
                            ...
                            />
                            <path
                              d="M25.1159 27.3107C25.8058 29.3933 27.3807 29.6016 28.5912 27.7793C29.6976 26.1133 28.9687 24.7466 26.9642 24.7466C25.4804 24.7336 24.6474 25.892 25.1159 27.3107Z"
                              stroke="#012964"
                              strokeWidth="1.95242"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                          ...
                          >
                            ...
                            product.data[1].typeOfUse ===
                              ...
                              <SvgIcon sx={{ ml: "3px", fontSize: "18px" }}>
                                ...
                                >
                                  <path
                                    d="M5.48343 1.42468V16.9782M3.15039 1.81352V5.70191C3.15039 7.64611 5.48343 7.64611 5.48343 7.64611C5.48343 7.64611 7.81646 7.64611 7.81646 5.70191V1.81352M13.2602 7.64611V16.9782M13.2602 7.64611C14.5488 7.64611 15.5932 6.25329 15.5932 4.5354C15.5932 2.8175 14.5488 1.42468 13.2602 1.42468C11.9716 1.42468 10.9272 2.8175 10.9272 4.5354C10.9272 6.25329 11.9716 7.64611 13.2602 7.64611Z"
                                    stroke="#727491"
                                    strokeWidth="1.0369"
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
                          ...
                          >
                            ...
                            {product.data[1].weight === "کیسه ۲۵ کیلوگرمی" ? (
                              <SvgIcon sx={{ ml: "2px" }}>
                                ...
                                "کارتن ۲۵ کیلوگرمی" ||
                              product.data[1].weight === "کارتن ۱۰ کیلوگرمی" ? (
                              <SvgIcon sx={{ ml: "2px" }}>
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  width="20"
                              ...
                              <SvgIcon sx={{ ml: "2px" }}>
                                ...
                                "بشکه ۲۵۰ کیلوگرمی" ||
                              product.data[1].weight === "بشکه ۲۱۵ کیلوگرمی" ||
                              product.data[1].weight === "درام ۲۵ کیلوگرمی" ? (
                              <SvgIcon sx={{ ml: "2px" }}>
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  width="20"
                                ...
                                >
                                  <g clipPath="url(#clip0_378_300)">
                                    ...
                                    <path
                                      ...
                                      fillRule="evenodd"
                                      clipRule="evenodd"
                                      d="M5.96441 3.01624C6.72441 3.01624 7.48441 3.01624 8.24441 3.01624C8.24441 3.07957 8.24441 3.1429 8.24441 3.20624C8.30773 3.20624 8.3711 3.20624 8.43441 3.20624C8.43441 3.45957 8.43441 3.7129 8.43441 3.96624C8.3711 3.96624 8.30773 3.96624 8.24441 3.96624C8.24441 4.02957 8.24441 4.0929 8.24441 4.15624C7.48441 4.15624 6.72441 4.15624 5.96441 4.15624C5.96441 4.0929 5.96441 4.02957 5.96441 3.96624C5.9011 3.96624 5.83773 3.96624 5.77441 3.96624C5.77441 3.7129 5.77441 3.45957 5.77441 3.20624C5.83773 3.20624 5.9011 3.20624 5.96441 3.20624C5.96441 3.1429 5.96441 3.07957 5.96441 3.01624Z"
                                      fill="#727490"
                                    />
                                  </g>
                                  <defs>
