...
const ProductDetails = () => {
  ...
  return (
    <>
      ...
      <Head>
        <title>
          بازرگانی بارمان تجارت پایدار - {product.data[1].name_Persian}
        </title>
        <meta
          name="description"
          content={`صفحه مشاهده محصول ${product.data[1].name_Persian} در وب سایت بازرگانی بارمان تجارت پایدار. BTP`}
        />
        <meta charSet="UTF-8" />
        <meta
          name="subject"
          content={`صفحه مشاهده محصول ${product.data[1].name_Persian}`}
        />
        <meta name="copyright" content="بازرگانی بارمان تجارت پایدار (BTP)" />
        <meta name="robots" content="index,follow" />
        <meta name="language" content="FA" />
        <meta name="url" content={`https://btp.one/Products/${product?.id}`} />
      ...
      >
        ...
        >
          ...
          >
            <Box
              ...
              sx={{
                ...
                marginInline: { sm: "auto", md: "50px", lg: "150px" },
          ...
          >
            ...
            >
              ...
              >
                محصولات / {product.data[1].category}
              </Typography>
              <Typography
                variant="h1"
                sx={{
            ...
            <Grid item md={12} mt={5} sx={{ mx: { xs: "20px", md: "0px" } }}>
              ...
              <Grid>
                ...
                >
                  ...
                  >
                    {product.data[1].name_Persian} و کاربرد های آن را بیشتر
                    بشناسید
                    <SvgIcon>
                      <svg
                      ...
                      >
                        <path
                          d="M23.5988 10.496L16.1083 17.9866C15.2236 18.8712 13.7761 18.8712 12.8915 17.9866L5.40088 10.496"
                          stroke="#1F2241"
                          strokeWidth="3"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
        ...
        >
          ...
          >
            {product.data[1].name_Persian} و کاربرد های آن را بیشتر بشناسید
            <SvgIcon>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="29"
